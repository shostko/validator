...
fun <T> Flowable<T>.validation(validator: (T) -> Flowable<Boolean>): FlowableValidation<T> = FlowableValidation(validator) { this }
...
fun <T> Observable<T>.validation(validator: (T) -> Flowable<Boolean>): ObservableValidation<T> = ObservableValidation(validator) { this }
...
fun <T> Single<T>.validation(validator: (T) -> Flowable<Boolean>): SingleValidation<T> = SingleValidation(validator) { this }
...
fun <T> Maybe<T>.validation(validator: (T) -> Flowable<Boolean>): MaybeValidation<T> = MaybeValidation(validator) { this }
